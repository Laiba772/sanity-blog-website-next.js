    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-10">
      <div className="w-full max-w-lg p-6 bg-white shadow-xl rounded-lg">
        ...
        <button
          ...
          className={`w-full ${isPosting ? "bg-gray-500" : "bg-blue-500"} text-white p-3 rounded-md hover:bg-blue-600 transition-all`}
          disabled={isPosting}
        >
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  aria-label={`Delete comment by ${commentData.username}`}
                >
                  Delete
                </button>
              </div>
